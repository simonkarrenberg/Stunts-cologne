...
(function (root) {
  ...
  const CARS = [
    ...
    { id: 'special', name: 'Milieu-Benz 280 SE', sub: 'Schwarz, lang, Chrom. Dat Auto vum Ring. Fahrer: der Lange T.', color: 0x0e0e12, stripe: 0xff2d95, shape: 'limo',
  ...
  const DRIVERS = [
    ...
    { id: 'langer', name: 'Langer T.', diff: 'EXPERTE', diffN: 3, quote: 'Du kütts hee nit rein!', sub: 'Türsteher, Zocker, Legende. Seit 1961 op de Ringe.',
  ...
  const TRACKS = [
    {
      ...
      props: [
        ...
        { type: 'denkmal', seg: 4, u: 0.35, side: -1, dist: 14, story: 'Tünnes un Schäl. Der eine ehrlich un e bessje dumm, der andere schlau un e bessje krumm. Zesamme: Kölle.' },
        ...
        { type: 'marktstand', seg: 4, u: 0.3, side: 1, dist: 13 }, { type: 'marktstand', seg: 4, u: 0.4, side: 1, dist: 13 }, { type: 'marktstand', seg: 4, u: 0.5, side: 1, dist: 13 },
        { type: 'blitzer', seg: 2, u: 0.9, side: -1, dist: 8 },
        { type: 'moewen', seg: 10, u: 0.5, side: 1, dist: 30, face: false },
        { type: 'zeppelin', seg: 10, u: 0.3, side: -1, dist: 80, face: false },
        { type: 'polizei', seg: 8, u: 0.2, side: -1, dist: 10 },
        { type: 'blitzer', seg: 14, u: 0.8, side: 1, dist: 8 },
        ...
        { type: 'rathaus', seg: 4, u: 0.5, side: 1, dist: 42, keep: 70, story: 'Rathaus. Hee wohnt der Klüngel. Man kennt sich, man hilft sich. Un wer keinen kennt, wartet.' },
        ...
        { type: 'hbarch', seg: 10, u: 0.5, side: 0, dist: 0, story: 'Hohenzollernbrücke. 500.000 Liebesschlösser. Un e paar Schlüssel im Rhing, die han ich selbst jeworfe.' },
        ...
        { type: 'tanzbrunnen', seg: 14, u: 0.15, side: -1, dist: 45, keep: 40 },
        { type: 'rhine', seg: 13, u: 0.55, side: 0, dist: 0 },
        { type: 'boat', seg: 13, u: 0.5, side: 1, dist: 55 },
        { type: 'rheinsprung', seg: 12, u: 0.6, side: 1, dist: 10 },
        { type: 'tramline', seg: 14, u: 0.5, side: 1, dist: 14, len: 120, face: false },
        { type: 'row', seg: 14, u: 0.3, side: -1, dist: 24, style: 'concrete', seed: 4, n: 5 },
        { type: 'koelsch', seg: 14, u: 0.9, side: 1, dist: 18 },
        { type: 'billboard', seg: 16, u: 0.3, side: -1, dist: 14, text: 'CHICAGO AM RHEIN – MAN KENNT SICH' },
        { type: 'flag', seg: 16, u: 0.6, side: 1, dist: 9 }
      ]
    },
    {
      ...
      props: [
        ...
        { type: 'riesenrad', seg: 5, u: 0.5, side: -1, dist: 60, keep: 50 },
        { type: 'beach', seg: 6, u: 0.5, side: 1, dist: 62, keep: 60 },
        { type: 'palm', seg: 6, u: 0.3, side: 1, dist: 12, h: 8, seed: 11 }, { type: 'palm', seg: 6, u: 0.7, side: 1, dist: 12, h: 7, seed: 12 },
        { type: 'neon', seg: 6, u: 0.2, side: -1, dist: 13, text: 'FLAMINGO BAR', color: '#ff2d95', small: true, light: false },
        { type: 'bude', seg: 8, u: 0.5, side: -1, dist: 11, text: 'FISCHBRÖTCHEN · KÖLSCH' },
        { type: 'palm', seg: 15, u: 0.3, side: -1, dist: 11, h: 8, seed: 8 }, { type: 'palm', seg: 15, u: 0.6, side: -1, dist: 11, h: 7, seed: 9 },
        { type: 'polizei', seg: 15, u: 0.8, side: 1, dist: 10 },
    ...
    },
    {
      ...
      props: [
        ...
        { type: 'speedboat', seg: 13, u: 0.5, side: 1, dist: 80, face: false },
        ...
        { type: 'hafenkran', seg: 13, u: 0.5, side: 1, dist: 48 },
        { type: 'barge', seg: 13, u: 0.5, side: 1, dist: 80 },
        { type: 'rhineSide', seg: 13, u: 0.5, side: 1, dist: 170, l: 300, w: 200 },
    ...
    },
    {
      ...
      props: [
        ...
        { type: 'blitzer', seg: 18, u: 0.5, side: -1, dist: 8 },
    ...
    },
    {
      ...
      desc: 'Die Tour vom Langen Tünn als Rennen: vom Residenz-Kino über die Friesenstraße am Klein Köln vorbei, Sartory, Lovers Club, Hansaring. Nacht, Neon, nasse Straßen, Zocker, Türsteher, Kripo. 1968. Nix für Sonntagsfahrer.',
      theme: { sky: 0x070a24, fog: 0x2a1a4a, ground: 0x23232e, sun: 0x9fb4ff, road: [0x2c2e3a, 0x25272f], night: true, wet: true, water: 0x102040, street: 'gruenderzeit', catenary: true,
        ...
        shops: ['BOXKELLER', 'TANZ LOKAL', 'KIOSK', 'BRAUHAUS', 'NACHTCAFÉ', 'CASINO', 'IMBISS', 'TÜNN’S BAR', 'BILLARD', 'SPÄTI', 'DISCO', 'KÖLSCH', 'FLAMINGO BAR', 'VICE LOUNGE', 'KLÜNGEL & CO'],
        posters: ['BOXKELLER', 'TÜNN LIVE', 'KÖLSCH-NACHT', 'VICE KÖLLE', 'FC HEIMSPIEL'],
  ...
  const TUENN = {
    ...
    intro: [
      ...
      'Ich bin der Lange T. Mir jehört die Streck, der Asphalt un dat Kölsch danach.',
    ...
    radio: [
      ...
      'RADIO KÖLLE: Blitzer op der Zoobrücke. Der Lange T. hät ihn selbst opjestellt.',
      ...
      'RADIO KÖLLE: Die Polizei bittet: fahrt nit schneller als der Lange T. Der hät Freunde.',
    ...
    slogans: ['KÖLLE IST KEINE STADT. KÖLLE IST EIN GEFÜHL.', 'WILLKOMME IN KÖLN. GAS, HÄTZ UN VERSTAND – DAT ES KÖLLE 4D.', 'ET HÄTZ SCHLECHT, ÄVVER ET KÜTT!', 'WENN ET NACHT WIRD IN KÖLLE, VERZÄLLT DER LANGE T.', 'CHICAGO AM RHEIN, 1968. DU KÜTTS HEE NIT REIN.']
  };
