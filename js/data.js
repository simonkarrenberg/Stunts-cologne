...
(function (root) {
  ...
  const TRACKS = [
    ...
    },
    {
      ...
      props: [
        { type: 'zockertisch', seg: 8, u: 0.5, side: -1, dist: 11, story: 'Am Hafen wird jezockt, seit et de Hafen jibt. Die Kranhäuser hann se och verspillt. Zweimal.' },
        { type: 'tuenn', seg: 0, u: 0.02, side: 1, dist: 9 },
        { type: 'crowd', seg: 0, u: 0.06, side: -1, dist: 10 },
