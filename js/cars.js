...
(function () {
  ...
  const SPECS = {
    ...
    wedge:  { L: 4.14, W: 2.0, wr: 0.33, floor: 0.2, // Countach: razor wedge, cab-forward, wide rear, flat tail
      body: [[-2.07, 0.62, 0.9], [-1.9, 0.72, 0.98], [-0.7, 0.78, 1], [0.6, 0.66, 1], [1.5, 0.52, 0.96], [2.07, 0.42, 0.78]],
      cabin: [[0.9, 0.62, 0.86], [0.25, 1.04, 0.86], [-0.55, 1.07, 0.86], [-1.2, 0.98, 0.86], [-1.9, 0.76, 0.88]],
      ax: [1.35, -1.35], lights: 'popup', grille: 'slot', spoiler: true, wedge: true },
